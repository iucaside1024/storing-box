...
;选项
[glink target="set_ja" text="日本語" shadow="0xe5e5e5" size=25 x=513 y=32 graphic="button/select.png" font_color="black" width=154 height=21]
[glink target="set_ch" text="简体中文" shadow="0xe5e5e5" size=25 x=813 y=32 graphic="button/select.png" font_color="black" width=154 height=21]
...
[jump  storage="config.ks"  target="config_page"  ]
[s]
